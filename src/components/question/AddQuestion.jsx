...
const AddQuestion = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      const response = await axios.get(
        `http://136.111.150.230:8080/api/categories/set/${questionSetId}`,
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "http://136.111.150.230:8080/codingQuestions/add",
        questionAdder,
      );
  ...
  const addTestCases = async (questionId) => {
    ...
    try {
      ...
      await axios.post(
        "http://136.111.150.230:8080/api/testcases/add",
        testCasesToAdd,
      );
  ...
  const handleAddCategory = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://136.111.150.230:8080/api/categories/add",
        categoryData,
      );
  ...
  const handleRunCode = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://136.111.150.230:8080/api/compiler/compile",
        {
          sourceCode,
