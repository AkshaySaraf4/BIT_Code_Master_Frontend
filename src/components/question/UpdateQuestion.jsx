...
const UpdateQuestion = () => {
	...
	const handleAddCategory = async () => {
		...
		try {
			...
			const response = await axios.post("http://136.111.150.230:8080/api/categories/add", categoryData);
	...
	const addTestCases = async (questionId) => {
		...
		try {
			await axios.post("http://136.111.150.230:8080/api/testcases/add", testCasesToAdd);
		} catch (error) {
